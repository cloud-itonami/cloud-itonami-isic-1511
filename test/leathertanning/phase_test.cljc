...
(deftest phase-3-auto-commits-only-no-risk-ops
  (testing ":log-production-batch carries no physical/environmental risk -- auto-eligible; it is the ONLY auto-eligible op in this domain"
