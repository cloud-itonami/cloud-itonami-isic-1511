# Operator Quickstart — Tanning and dressing of leather

Shortest path from clone to a verified local dry-run for **ISIC 1511** (`cloud-itonami-isic-1511`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1511.git
cd cloud-itonami-isic-1511
```
...
- Blueprint governor key: `leather-tanning-plant-operations-governor`
- Likely source path: `leathertanning.governor.cljc`
