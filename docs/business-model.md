# Business Model: Tanning and dressing of leather
...
## Classification
- Repository: `cloud-itonami-isic-1511` ([github.com/cloud-itonami/cloud-itonami-isic-1511](https://github.com/cloud-itonami/cloud-itonami-isic-1511))
- ISIC Rev.5: `1511` — Tanning and dressing of leather
- Domain: `:leather-tanning/plant-operations`
- Social impact: :worker-safety :environmental-stewardship :supply-chain-traceability
- Actor: `:leather-tanning-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :leather-tanning/plant-operations — who wants
...
One managed tenant (:leather-tanning/plant-operations):
...
- Do not bypass the `:leather-tanning-plant-operations-governor` for production decisions.
